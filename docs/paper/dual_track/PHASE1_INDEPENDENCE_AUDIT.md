...
5. **Detector-touching packs (documented):**
   - `configs/phase1_detector_lock.json` + `docs/experiments/PHASE1_DETECTOR_STUDY.md`: DEV/VAL = Layer A train/dev; confirm pack **no tuning**; holdout = pilot; lock forbids edits justified by holdout or confirm outcomes
