...
|------|----------------------|
| Adaptive attacker aware of the defense | Explicitly excluded from Phase-1 threat model (`docs/experiments/PHASE1_THREAT_MODEL.md`: no live multi-turn adaptive attacker in Phase 1) |
